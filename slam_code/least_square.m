function [poses, landmarks] = least_square(landmarks, poses, transitions, observations, id_to_landmark, niterations)
...
function [e, Ji, Jj] = errorAndJacobianPP(pi, pj, z)
    # here we apply the flattening technique seen for pose-pose constraints
    Xi = v2t(pi);
    Xj = v2t(pj);
    Z = v2t(z);
    df = Xi^-1 * Xj;
